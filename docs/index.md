...
This repository is the **library** (`argospy`). Product cases belong in a pack repo. Dash is optional infrastructure in **argos-dash** (Acahti); the library does not require it. See [Architecture](architecture.md).
